...
require_once("lib_alipay_func.php");
...
//     function build_url() {
//        return $this->gateway."_input_charset=".$this->parameter['_input_charset'];
//    }
//    /********************************************************************************/
//
//    /**构造表单隐藏字段
...
//            $htm .= "<input type='hidden' name='".$key."' value='".$val."'/>";
//        }
//        $htm = $htm."<input type='hidden' name='sign' value='" . $this->mysign . "'/>";
//        $htm = $htm."<input type='hidden' name='sign_type' value='" . $this->sign_type . "'/>";
//        return $htm;
//    }
//    /********************************************************************************/
