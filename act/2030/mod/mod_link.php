...
class mod_link extends mod_base_info {
    ...
    function mod_load() {
        ...
        $this->key_search = array('name',  'menu_name');
    }
    ...
    function list_read() {
        $ws_id = i_ws_id_get();
        $table = $this->xtb . ' AS x ';
        $field = ' id, name, atime, hits, u_name, menu_name, ws_id, drwx, oid ';
