...
$ws['info'] = $mod->info_read_job($xid);
$ws['com'] = $mod->info_read_com4job($ws['info']['cid']);
$ws['list_job'] = $mod->list_read_job4com($ws['info']['cid']);
...
$mkf = m_app . 'www/info_job_' .$xid . '.htm';  //定义生成文件路径
