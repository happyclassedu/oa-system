...
class mod_insured extends mod_base_info {
    ...
    function list_load() {
        ...
        $this->key_search = array('idcard', 'name', 'ins_code', 'birth', 'disability');
    }
    ...
    function list_read() {
        $this->list_load();
        $table = $this->xtb . ' AS x ';
        $field = ' x.id, x.name, x.sex, x.idcard, x.ins_code, x.ins_base, x.org_2, x.org_1, x.disability, x.bankcard_code, x.tel_1 ';
        $where = ' x.drwx=0 ';
