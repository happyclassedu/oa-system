...
class mod_ins_pay extends mod_base_info {

    /**
     * mod_load : 模型初始化定义主表等。
     */
    function mod_load() {
        $this->xtb = '#@__cfg_ins_pay';
    }
    ...
    function list_load() {
        ...
        $this->key_search = array('year', 'ins_pay');
    }
    ...
    function list_read() {
        $this->list_load();
        $table = $this->xtb . ' AS x ';
        $field = ' x.id, x.year, x.ins_pay, x.remark ';
        $where = ' x.drwx=0 ';
