...
class mod_leave extends mod_base_info {

    /**
     * mod_load : 模型初始化定义主表等。
     */
    function mod_load() {
        $this->xtb = '#@__hrms_hm_l';
    ...
    function list_read() {
        $table = $this->xtb . ' AS x ';
//        $field = ' x.id, x.hm_name, x.hm_code, x.go_date, x.in_date, x.apply_date, x.leave_day, x.leave_state ';
        $field = ' x.id, x.hm_name, x.hm_code, x.go_date, x.in_date ';
        $where = ' x.drwx=0 ';
        $order = ' ';
