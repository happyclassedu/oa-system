  //创建和初始化地图函数：
    ...
    function createMap(){
        ...
        var point = new BMap.Point(108.965538,34.266393);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"立丰（西安）房地产开发有限公司",content:"西安市东大街233号新城区,&nbsp;西安市,&nbsp;陕西省<br/>公交／驾车<br/>029-87415000<br/>公交车站:&nbsp;端履门&nbsp;(西&nbsp;423&nbsp;米)&nbsp;&nbsp;7路,&nbsp;7路区间,&nbsp;8路,&nbsp;29路,&nbsp;37路,&nbsp;43路,&nbsp;45路,&nbsp;46路,&nbsp;118路,&nbsp;201路,&nbsp;…",point:"108.965376|34.266199",isOpen:0,icon:{w:21,h:21,l:46,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
