...
function m_init_info_ytext_set() {
    var ytext = '';
    ytext +=  '经办人：' + i_obj_val('d_bname') + '；党员类型：' + i_obj_val('d_party_type') +  '；<br>';
...
//业务操作条件
function m_oh_condition() {
    if('预备党员' == m.info['party_type'] && '在库' == m.info['party_state']){
        return true;
    } else {
        return false;
    }
