...
function m_init_info_ytext_set(){
    var ytext = '';
    ytext +=  '团费截止日期：' + i_obj_val('d_i_date') + '；缴纳金额：' + i_obj_val('d_i_txt0') +  '；<br>' ;
    ytext +=  '总计：' + i_obj_val('d_i_txt1') + '；经办人：' + i_obj_val('d_bname')+  '；<br>';
