swfobject.embedSWF("../img/header_banner.swf", "header_banner", "976", "150", "9.0.0", null, false, {
    wmode:"transparent"
});
...
function m_www_css_act() {
    $('#link0').addClass('link_img');
    $('#link1').addClass('link_img');
    $('#link2').addClass('link_img');
    $('#link3').addClass('link_txt');
    $('#link4').addClass('link_ads');
}

function m_www_menu_act() {
    $('#menuer a[href^="http"]').attr('target', '_blank');
}
