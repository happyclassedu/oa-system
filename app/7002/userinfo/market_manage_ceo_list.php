...
<table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC" class="bianmamanage">
  <tr> 
    <td bgcolor="#EBEBEB" class="tishi" colspan="8">&nbsp;管理市场活动</td>
  </tr>
				...
				<td  width=10%  class="usermanage_1">所有者</td>
				<td  width=24%  class="usermanage_1">开始及结束日期</td>
...
if ($ggallrows==0)
{
	echo "<tr><td align='center' bgcolor='#FFFFFF' height='25' colspan='7'>暂无您要查询的数据！</td></tr>";
				...
				<td  width=24%  class="usermanage_2"><?=$starttime."至".$endtime;?></td>
