...
<form name="myform" method="post" action="client_manage_list.php" onsubmit="return FormCheck();">
...
<table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC" class="bianmamanage">
  <tr> 
    <td bgcolor="#EBEBEB" class="tishi" colspan="7">&nbsp;客户信息管理</td>
  </tr>
...
?>	
	...
	$link="client_manage_list.php?clientname=".$clientname;
