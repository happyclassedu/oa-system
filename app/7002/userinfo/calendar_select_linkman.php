...
<SCRIPT   LANGUAGE="JavaScript">   
  <!--   
  function  CloseSelf(linkname,linknameid,clientname,clientnameid,address_str){  
// alert  (clientname);
    ...
    window.opener.document.myform.str_address.value=address_str;
...
//	var clientname=;
  ...
  //-->   
					...
					<a href="" id="td<?=$id;?>"  onclick="CloseSelf(linkname<?=$id;?>,linknameid<?=$id;?>,clientname<?=$id;?>,clientnameid<?=$id;?>,address<?=$id;?>);"><?=$name;?></a></td>
				<td  width=61%  class="usermanage_2"><?=$client_name;?></td>
				<td  width=8%  class="usermanage_2"><a href="" id="td<?=$id;?>"  onclick="CloseSelf(linkname<?=$id;?>,linknameid<?=$id;?>,clientname<?=$id;?>,clientnameid<?=$id;?>,address<?=$id;?>);">选择</a></td>
