...
function i_error_msg(id, msg, type){
    if('1' == type){
        ...
        i_obj_set(id, '<img src="../img/bang.gif" align="absBottom">&nbsp;&nbsp;' + msg);
        $("#" + id).css("color","red");
    } else if('2' == type) {
        i_obj_set(id, '' + msg);
        $("#" + id).css("color","green");
...
/**
* 函数i_check_email：检查输入的邮箱格式是否正确
* param :str  字符串
* return:true 或 flase; true表示格式正确
*/
function i_check_email(str){
...
/**
* 函数i_check_qq：检查QQ的格式是否正确
* param:str  字符串
* return:true 或 flase; true表示格式正确
*/
function i_check_qq(str){
...
/**
* 函数i_check_postcode：检查输入的邮政编码格式是否正确
* param:str  字符串
* return:true 或 flase; true表示格式正确
*/
function i_check_postcode(str){
...
/**
* 函数i_check_cardid：检查输入的身份证格式是否正确
* param:cardid 身份证号码；
* param:errorid 报错id；
* param:sex 性别表单id；
...
* return:true 或 flase; true表示格式正确
*/
function i_check_cardid(cardid, errorid, sexid , birthid) {
    //	var cardid = "61052819840504062X";  //测试用例
    var check_result = i_check_cid(i_obj_val(cardid));
    if (check_result!="ok") {
...
/**
* 函数i_check_cid：检测身份证号码是否合法
* param:cardid  身份证号码；
* reutrn:errors 错误数组值。
*/
function i_check_cid(cardid){  //检测身份证号码是否合法
